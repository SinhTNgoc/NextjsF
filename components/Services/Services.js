            ...
            <div className={classes.colcontent}>
              <div className={classes.serivcescontent}>
                ...
                <p className={classes.servicesdes}>
                  Our certified cloud architects/developers provide cutting-edge
                  designs to build cloud-based and hybrid applications.
                </p>
            ...
            <div className={classes.colcontent}>
              <div className={classes.serivcescontent}>
                ...
                <p className={classes.servicesdes}>
                  ...
                  analysis, design, coding, testing, deployment, maintenance and
                  supporting.
                </p>
          ...
          <div className={classes.row}>
            ...
            <div className={classes.colcontent}>
              <div className={classes.serivcescontent}>
                ...
                <p className={classes.servicesdes}>
                  We offer you specific teams for your specific needs. We assign
                  a customise skill set to each client so that the project gets
                  complete dedication and required attention.
                </p>
